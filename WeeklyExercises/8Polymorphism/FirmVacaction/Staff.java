...
public class Staff
{
   ...
   public void payday()
   {
      ...
      for (int count=0; count < staffList.length; count++)
      {
         ...
         holidayTotal = staffList[count].holiday();
         ...
         System.out.println("Holidays: " + holidayTotal);
